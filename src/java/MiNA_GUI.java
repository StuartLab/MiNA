...
public class MiNA_GUI implements Command {
    @Parameter
    ...
    private static final int WINDOW_WIDTH = 750,  WINDOW_HEIGHT= 440;
    public int window_height = WINDOW_HEIGHT;
    public int bottomPanel_height = 200;
    public String preProcessorPath = "", postProcessorPath = "";
    ...
    public void runMiNA(boolean preview){
        ...
        parameters.put("preprocessor_path", preProcessorPath);
        parameters.put("postprocessor_path", postProcessorPath);
    ...
    public void run(){
        ...
        Image warnImg = warnIcon.getImage().getScaledInstance(30,30,Image.SCALE_SMOOTH);
        warnIcon = new ImageIcon(warnImg);
        JButton warningBttn = new JButton(warnIcon);
        ...
        JTextField preProcText = new JTextField();
        JTextField postProcText = new JTextField();
        preProcLabel.setBounds(40, 52, 150, 20);
        postProcLabel.setBounds(40, 77, 150, 20);
        preProcText.setBounds(190, 50, 300, 25);
        postProcText.setBounds(190, 77, 300, 25);

        JButton browseButtonPre = new JButton("Choose File");
        JButton browseButtonPost = new JButton("Choose File");
        browseButtonPre.setBounds(495, 50, 110, 25);
        browseButtonPost.setBounds(495, 77, 110, 25);
        ...
        commentLabel.setBounds(commentL_X, commentL_Y, 100, 20);
        ...
        // Rescale info icon image
        Image iconImg = infoIcon.getImage().getScaledInstance(23,23,Image.SCALE_SMOOTH);
        infoIcon = new ImageIcon(iconImg);

        JButton infoMedian = new JButton(infoIcon);
        JButton infoUnsharp = new JButton(infoIcon);
        JButton infoClahe = new JButton(infoIcon);
        JButton infoRidgeD = new JButton(infoIcon);
        JButton preProcInfo = new JButton(infoIcon);
        JButton posProcInfo = new JButton(infoIcon);
        JButton commentsInfo = new JButton(infoIcon);
        JButton[] infoButton = {infoMedian,infoUnsharp,infoClahe,infoRidgeD, preProcInfo, posProcInfo, commentsInfo};

        infoMedian.setBounds(193,150,23,23);
        infoUnsharp.setBounds(385,150,23,23);
        infoClahe.setBounds(680,150,23,23);
        infoRidgeD.setBounds(240,90,23,23);
        preProcInfo.setBounds(610, 50, 23, 23);
        posProcInfo.setBounds(610, 77, 23, 23);
        ...
        lineL.setBounds(40, 105, labelWidth, 15);
        highCs = new JSpinner();
        lowCs = new JSpinner();
        lineWs = new JSpinner();
        lineLs = new JSpinner();
        highCs.setBounds(labelWidth + 35, 15, labelWidth, 20);
        lowCs.setBounds(labelWidth + 35, 45, labelWidth, 20);
        lineWs.setBounds(labelWidth + 35, 75, labelWidth, 20);
        lineLs.setBounds(labelWidth + 35, 105, labelWidth, 20);
        ...
        ridgeDetection.addItemListener(e -> {
            if (e.getStateChange() == ItemEvent.DESELECTED){
                ...
                commentLabel.setBounds(commentL_X, commentL_Y+ 150, 100, 20);
        ...
        medianCB.setBounds(95, 150, 97, 20);
        orderMedian.setBounds(49, 150, 46, 18);
        medianRadLabel.setBounds(55, 170, 50, 20);
        medianRadSpin.setBounds(97, 170, 50, 20);
        ...
        unsharpCB.setBounds(275, 150, 111, 20);
        orderUnsharp.setBounds(227, 150, 46, 18);
        unsharpRadLabel.setBounds(230, 170, 100, 20);
        unsharpRadSpin.setBounds(320, 170, 50, 20);
        unsharpWeightLabel.setBounds(230, 190, 100, 20);
        unsharpWeightSpin.setBounds(320, 190, 50, 20);
        ...
        JLabel claheSlopLabel = new JLabel("maximum slope");
        ...
        claheCB.setBounds(475, 150, 205, 20);
        orderClahe.setBounds(425, 150, 46, 18);
        clahePanel.setBounds(410, claheYbound, 300, 80);
        claheBlockLabel.setBounds(10, 0, 100, 20);
        claheBlockSpin.setBounds(110, 0, 100, 20);
        claheHisLabel.setBounds(10, 20, 100, 20);
        claheHisSpin.setBounds(110, 20, 100, 20);
        claheSlopLabel.setBounds(10, 40, 100, 20);
        claheSlopSpin.setBounds(110, 40, 100, 20);
        maskLabel.setBounds(10, 60, 50, 20);
        claheMask.setBounds(110, 60, 125, 20);
